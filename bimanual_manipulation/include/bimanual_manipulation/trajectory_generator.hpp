...
{
public:
  // Straight line in joint space from start to goal.
  ...
  // Straight line of the tip in Cartesian space, IK solved per waypoint.
...
private:
  // Velocity/acceleration limited timing for a sequence of joint waypoints.
